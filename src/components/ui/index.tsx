...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-85 active:scale-[0.98]",
        sizes[size],
        className,
      )}
    ...
    return (
      <div className="w-full">
        ...
        <input
          ref={ref}
          className={cn(
            "w-full px-3.5 py-2.5 rounded-lg text-sm transition-all",
            className,
          )}
          style={{
            background: "var(--surface-2)",
    ...
    return (
      <div className="w-full">
        ...
        <select
          ref={ref}
          className={cn(
            "w-full px-3.5 py-2.5 rounded-lg text-sm transition-all appearance-none cursor-pointer",
            className,
          )}
          style={{
            background: "var(--surface-2)",
    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ref={ref}
          className={cn(
            "w-full px-3.5 py-2.5 rounded-lg text-sm transition-all resize-none",
            className,
          )}
          style={{
            background: "var(--surface-2)",
...
export function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      />
      <div
        className="relative w-full max-w-lg rounded-2xl animate-slide-up"
        style={{
          background: "var(--surface)",
          border: "1px solid var(--border)",
